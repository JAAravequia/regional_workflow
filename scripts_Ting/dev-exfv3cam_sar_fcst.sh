...
#clt startmsg
#clt for thompson ${APRUNC} $EXECfv3/regional_forecast.x_thompson >$pgmout 2>err
module list
export HDF5_DISABLE_VERSION_CHECK=1
#${APRUNC} $EXECfv3/regional_forecast.x >$pgmout 2>err
export EXEDIR=/work/noaa/nems/jabeles
#exec0=$EXEDIR/ufs-weather-model/tests/fv3_32bit_thompson.exe
${APRUNC} /work/noaa/fv3-cam/jaravequ/regional_workflow/exec/regional_forecast.x >$pgmout 2>err
#${APRUNC} $exec0 >$pgmout 2>err
