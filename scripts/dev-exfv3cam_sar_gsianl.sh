...
::
 ...
 &SINGLEOB_TEST
   ...
   oblat=-23.,oblon=310.,obpres=500.,obdattim=${ANAL_TIME},
   obhourset=0.,
 /
 &NST
 /
...
export nmmb_nems_obs=${COMINgfs}/gdas.${PDYa}/${CYCrun}
...
# Try para RAP first
$ncp $nmmb_nems_obs/gdas.t${CYCrun}z.prepbufr.nr  ./prepbufr
...
# JAA work around try
cp $fixgsi/rtma_w_rejectlist ./w_rejectlist
cp $fixgsi/rtma_t_rejectlist ./t_rejectlist
cp $fixgsi/rtma_p_rejectlist ./p_rejectlist
cp $fixgsi/rtma_q_rejectlist ./q_rejectlist
...
cp $fv3_case/${PDY}.${CYCrun}0000.coupler.res coupler.res
#   This file contains vertical weights for defining hybrid volume hydrostatic pressure interfaces 
cp $fv3_case/${PDY}.${CYCrun}0000.fv_core.res.nc fv3_akbk
#   This file contains horizontal grid information
cp $fv3_case/../grid_spec${lbcupdt_str}.nc fv3_grid_spec
cp $fv3_case/${PDY}.${CYCrun}0000.sfc_data${lbcupdt_str}.nc fv3_sfcdata
#   This file contains 3d fields u,v,w,dz,T,delp, and 2d sfc geopotential phis
ctrlstrname=${ctrlstr:+_${ctrlstr}_}
   BgFile4dynvar=${BgFile4dynvar:-$fv3_case/${PDY}.${CYCrun}0000.${ctrlstrname}fv_core.res.tile1${lbcupdt_str}.nc}
   BgFile4tracer=${BgFile4tracer:-$fv3_case/${PDY}.${CYCrun}0000.${ctrlstrname}fv_tracer.res.tile1${lbcupdt_str}.nc}
   BgFile4dynvarOld=${BgFile4dynvar:-$fv3_case/${PDY}.${CYCrun}0000.${ctrlstrname}fv_core.res.tile1.nc}
   BgFile4tracerOld=${BgFile4tracer:-$fv3_case/${PDY}.${CYCrun}0000.${ctrlstrname}fv_tracer.res.tile1.nc}
